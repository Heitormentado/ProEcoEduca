...
namespace mf_dev_backend.Controllers
{
    public class ComentariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Texto")] Comentario comentario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Texto,Autor,DataCriacao")] Comentario comentario)
        {
            if (id != comentario.Id)
            {
                return NotFound();
